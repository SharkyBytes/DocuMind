      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
        <div className="container mx-auto px-4 py-16 flex flex-col items-center justify-center min-h-screen">
          ...
          <div className="flex space-x-4">
            <Link
              href="/sign-in"
              className="px-8 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors shadow-md flex items-center"
            >
              Sign In
            ...
            <Link
              href="/sign-up"
              className="px-8 py-3 bg-white text-blue-600 border border-blue-200 rounded-lg hover:bg-blue-50 transition-colors shadow-sm"
            >
              Create Account
            </Link>
          </div>
  ...
  return (
    <div className="bg-gradient-to-b from-slate-50 to-white min-h-screen overflow-hidden">
      <div className="flex flex-col lg:flex-row h-screen">
        ...
        <div className="lg:w-[30%] bg-white shadow-xl overflow-y-auto lg:fixed lg:left-0 lg:top-[60px] lg:bottom-0 z-10 border-r border-slate-200">
        ...
        <div className="lg:w-[70%] lg:ml-[30%] bg-slate-50 min-h-screen pt-[60px]">
          <ChatComponent />
        </div>
      </div>
    </div>
